...
<table width="651" border="0" cellspacing="1" cellpadding="0">
  <tr >
	...
	<div class="company_name">&nbsp;Sun Gold Tiles PTY LTD</div>
    <div class="address">&nbsp;PO Box 2843 Southport BC, QLD 4215<br />
&nbsp;Tel:&nbsp;0432475965<br />
&nbsp;</div></td>

<td colspan="2" id="border_name" >
	<font size=-1>Purchase Order Number</font><br>
	<span class="subcontent"><font size=-1></font></span> <span id='border_pon'><font size=-1><?=$list_Records[0]["orders_number"]?></font></span>
  ...
  <tr>
    ...
    <td width="100"></td>
    <td width="82" class="title">Receiver: </td>
    <td width="61"></td>
    <td width="220"></td>
   </tr>
  <tr>
  ...
  <tr>
    ...
    <?php if($list_Records[0]["orders_type"] !='B') { ?>
	  ...
	  <tr>
	<th width="130" class="main_top_content">Code No</th>
