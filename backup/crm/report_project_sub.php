...
<TR>
	...
	<TR>
		<TD valign="top" style="padding:10 10 10 10">
			...
			<tr class="font12_bold" bgcolor="#CECED0"><td colspan=5 height="30" align="center"><?=$total_list[0]["project_name"]?></td></tr>
			...
			<tr>
				...
				<td class="right" bgcolor="<?=$bgcolor?>"><?=($total_list[$i]["orders_inventory"])? $total_list[$i]["orders_inventory"] : ""; ?></td>
			...
			?>
			<tr class="font12_bold" bgcolor="#CECED0"><td colspan=5 height="30" align="right"><span class="font12_bold" >TOTAL :</span>&nbsp;<span class="quantity_bold02" ><?=($total_amount)? "$".number_format($total_amount,2,".",',') : "";?></span></td></tr>
			</table>
			<!-- TOTAL PROJECT END------------------------------------------------------------------------------------->
		</TD>
	</TR>
...
function goExcelPrint() {
	...
	//f.target="_blank";
	f.action="report_project_sub_excel.php";
	f.submit();
}
</script>
</BODY>
