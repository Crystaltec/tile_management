				...
				<tr>
					<td valign="top">
						...
						<tr align="center" <?php echo $even_odd;?> onmouseover="javascript:this.style.color='#536499';this.style.backgroundColor='#dcebfe';"  onmouseout="javascript:this.style.color='#000000';this.style.backgroundColor='';">
							...
							<td class="left"><input type="hidden" value="<?=$list_Records[$i]["project_id"]?>" name="project_id[]"><a href="project_view.php?project_id=<?=$list_Records[$i]["project_id"]?>"><b><?=$list_Records[$i]["project_name"]?></b></a>&nbsp;</td>
							<td class="left"><?=($list_Records[$i]["project_suburb"])?>&nbsp;</td>
							<td class="left"><?=($list_Records[$i]["project_phone_number"])?>&nbsp;</td>
