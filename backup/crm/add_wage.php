...
<thead class='ui-widget-header'>
	<tr><th colspan="3"><?php echo getValue("employee"," CONCAT_WS(' ',first_name, last_name) "," and id='".$eid."' ");?></th></tr>
	<tr><th>Amount</th>
		<th>Apply date</th>
		<th>Reg. date</th>
	</tr>
...
<table>
<thead class='ui-widget-header'>
	<tr><th colspan="3"><?php echo getValue("employee"," CONCAT_WS(' ',last_name,first_name) "," and id='".$eid."' ");?></th></tr>
	<tr><th>Amount</th>
		<th>Apply date</th>
		<th>Reg. date</th>
	</tr>
...
<?php } ?>
Click the amounts to assign to employee info.<br /><br />
<div>
