...
function goStep02() {
	...
	if ( qtychk) {
		f2.method="post";
		f2.action="purchase_order_ok.php";
		f2.submit();
	}
	else {
		...
		<tr>
			...
			<tr>
				...
				<tr>
					...
					<td width="800" colspan="3" class="dinput2" ><input type="text" name="orders_number" id="orders_number" value="<?=getPON($orders_number)?>"><input type="checkbox" name="orders_number_chk" id="orders_number_chk" <?php if($orders_number_chk) echo "checked";?> >Add on existed P.O.N. It won't check P.O.N.</td>
				</tr>
				<tr><td colspan="4" height="3" class="divider"></td></tr>
				<tr>
...
<div id="dialog-form" title="Add New Item">
	...
	<form>
		<fieldset>
		<label for="n_category"><span class="red">*</span> Category</label>
		...
		<label for="n_name"><span class="red">*</span> Name</label>
		<input type="text" name="n_name" id="n_name" value="" class="text ui-widget-content ui-corner-all" />
		<label for="n_code_number"><span class="red">*</span> Code Number</label>
		...
		<label for="n_unit"><span class="red">*</span> Unit</label>
		...
		<label for="n_price"><span class="red">*</span> Price</label>
		<input type="text" name="n_price" id="n_price" value="" class="text ui-widget-content ui-corner-all" /><br />
		<label for="n_supplier"><span class="red">*</span> Supplier</label>
