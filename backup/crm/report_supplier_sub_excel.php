...
header("Content-Disposition: attachment; filename=SUPPLIER_DETAIL-".$total_list[0]['supplier_name'].".xls");
...
<TR>
	...
	<TR>
		<TD valign="top" style="padding:10 10 10 10">
			...
			<tr class="font12_bold" bgcolor="#CECED0"><td colspan=4 height="30" align="center"><?=$total_list[0]["supplier_name"]?></td></tr>
