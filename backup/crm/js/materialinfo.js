            ...
            if(request.status == 200){
                ...
                if(resp != null) {
					...
					if (_index == 0)
					{
						...
						f.material_price0.value=objt.material_price0;
					...
					else if (_index==1)
					{
						...
						f.material_price1.value=objt.material_price1;
					}
					else if (_index==2)
					{
						...
						f.material_price2.value=objt.material_price2;
					}
					else if (_index==3)
					{
						...
						f.material_price3.value=objt.material_price3;
					}
					else if (_index==4)
					{
						...
						f.material_price4.value=objt.material_price4;
					}
					else if (_index==5)
					{
						...
						f.material_price5.value=objt.material_price5;
					}
					else if (_index==6)
					{
						...
						f.material_price6.value=objt.material_price6;
					}
					else if (_index==7)
					{
						...
						f.material_price7.value=objt.material_price7;
					}
					else if (_index==8)
					{
						...
						f.material_price8.value=objt.material_price8;
					}
					else if (_index==9)
					{
						...
						f.material_price9.value=objt.material_price9;
					}
				}
            } else {
