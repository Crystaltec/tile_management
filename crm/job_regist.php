...
<br>	<td valign="top" width="100" height="100%">
	<!-- LEFT -------------------------------------------------------------------------------------------------->
				...
				<tr>
					<td valign="top">
						...
						<tr >
							...
							Extra hours&nbsp;<?php getCustomizeOption("hour", "job_extra_hour", "", "","Hour");?> 
						...
						<tr >
							...
							<br />
							<em style='padding-left:100px;'>or</em><br />
							Extra hours&nbsp;<?php getCustomizeOption("hour", "job_extra_hour2", "", "","Hour");?> 
