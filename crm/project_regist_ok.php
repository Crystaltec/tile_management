...
$v_fc = $_POST["v_fc"];
$v_sc = $_POST["v_sc"];
$grout_com= $_REQUEST["grout_com"];
$silicone_com= $_REQUEST["silicone_com"];
$adhesive_com= $_REQUEST["adhesive_com"];
...
if ($action_type=="") {
	...
	" budget_fc, v_budget_fc, extra_t, extra_s, extra_w,contract_fc, contract_sc, v_fc, v_sc, grout_com, silicone_com, adhesive_com ) " .
	...
	if ($project_status == "COMPLETED") {
		...
		"', grout_com= '". $grout_com .
		"', adhesive_com = '". $adhesive_com .
		"', silicone_com = '". $silicone_com .
