	...
	<table border="1" cellpadding="0" style="float:left;" cellspacing="0" width="30%">
			...
			<table border="0" cellpadding="0" style="float:left;" cellspacing="0" width="1%">
				<td>&nbsp;</td>
					...
					<table border="1" cellpadding="0" style="float:left;" cellspacing="0" width="38%">
						...
						<th width="300">Notice</th>
							...
							<td align="center">Crystaltec</td>
							<td align="left">This Notification Message is for sample only please ignore this message. This Notification Message is for sample only please ignore this message.This Notification Message is for sample only please ignore this message. This Notification Message is for sample only please ignore this message </td>
						
						<tr>
							<td align="center">2</td>
							<td align="center">10-15-2015</td>
							<td align="center">Crystaltec</td>
							<td align="left">This Notification Message is for sample only please ignore this message. This Notification Message is for sample only please ignore this message.This Notification Message is for sample only please ignore this message. This Notification Message is for sample only please ignore this message </td></tr>
				</table>
