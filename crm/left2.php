...
?>
<table border="0" cellpadding="0" cellspacing="0" height="100%" width="191">
<tr>
	<td colspan="2" align="center"><a href="/order"><img src="images/logo4.jpg"></a></td>
</tr>
<tr>
	<td colspan="2"><img src="images/bar02.gif" width="176"></td><td width="14"></td>
</tr>
<tr>
...
echo "<tr><td width='20' style='border-right:1px solid #DFDFDF' align='right'><img src='images/icon_arrow01.gif'></td>
...
<td width='14'></td></tr>";
echo "<tr><td background='images/bg_check.gif' height='3' colspan='2'></td></tr>";
// submenu Selecting...
echo "<tr><td width='20' style='border-right:1px solid #DFDFDF'></td><td valign='top'>";
	...
	echo "</table></span>";
echo "</td><td width='14'></td></tr>";
}
?>
<tr><td colspan="3" height="100%" valign="bottom" align="center" style="padding-bottom:20px"><!--<img src="images/bottom_logo.jpg">--></td></tr>
</table>
<?php
if($_REQUEST["lmenu"]!="") {
